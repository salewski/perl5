...
# to set, and is multiplied by $ENV{PERL_TEST_TIME_OUT_FACTOR} (default 1;
# minimum 1).  Set this variable in your profile for slow boxes, or use it to
# override the timeout temporarily for debugging.
#
