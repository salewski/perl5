...
#define UNI_DISPLAY_ESCAPE      0x0008  /* Allow \e when also
                                           UNI_DISPLAY_BACKSLASH */
#define UNI_DISPLAY_QQ_ALL      (UNI_DISPLAY_ISPRINT|UNI_DISPLAY_BACKSLASH  \
                                |UNI_DISPLAY_ESCAPE)
/* UNI_DISPLAY_BACKSPACE is not enabled by default because it breaks code not
 * expecting it */
