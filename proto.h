...
PERL_CALLCONV UV	Perl_utf8_to_uvchr_buf_helper(pTHX_ const U8 *s, const U8 *send, STRLEN *retlen);
...
#define PERL_ARGS_ASSERT__APPEND_RANGE_TO_INVLIST	\
	assert(invlist)
STATIC UV*	S__invlist_array_init(SV* const invlist, const bool will_have_0)
			__attribute__warn_unused_result__;
...
STATIC HV*	S_opmethod_stash(pTHX_ SV* meth);
...
STATIC void	S_invlist_iterfinish(SV* invlist);
#define PERL_ARGS_ASSERT_INVLIST_ITERFINISH	\
	assert(invlist)
STATIC void	S_invlist_iterinit(SV* invlist);
...
#define PERL_ARGS_ASSERT_INVLIST_EXTEND	\
	assert(invlist)
#endif
STATIC UV	S_invlist_highest(SV* const invlist)
			__attribute__warn_unused_result__;
...
STATIC bool	S__invlist_contains_cp(SV* const invlist, const UV cp)
			__attribute__warn_unused_result__;
...
STATIC UV*	S_invlist_array(SV* const invlist)
			__attribute__warn_unused_result__;
